...
export default function Winners({ winners }: { winners: Winner[] }) {
  return (
    <div className="flex shrink-0 flex-wrap justify-between sm:justify-around">
      {winners.map((winner) => (
        <a
          ...
          className="border-primary mb-4 w-32 border border-solid shadow-lg hover:opacity-50 focus:opacity-50"
        >
